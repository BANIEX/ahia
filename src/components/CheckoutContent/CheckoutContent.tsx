...
import ReviewCartTotal from '../ReviewCartTotal/ReviewCartTotal';
  ...
  return (
    <div className={styles.checkout_content}>
      <div className={styles.shipping_payment}>
        <div className={styles.shipping_payment_sub_container}>
          <div className={styles.checkout_text}>Checkout Text</div>
          <div className={styles.shipping_info_text_wrapper}>
            <div>Shipping Information</div>
          </div>
          <div className={styles.shipping_info_input_wrapper}>
            <div className={styles.shipping_info_input_sub_wrapper}>
              ...
              <div className={styles.apartment_input_wrapper}>
                <input
                  type="text"
                  placeholder="Apartment, suite, etc (optional)"
                />
              </div>
              <div className={styles.city_input_wrapper}>
                <input type="text" placeholder="City" />
              </div>

              <div className={styles.country_input_wrapper}>
                <input type="text" placeholder="Country" />
                <input type="text" placeholder="City" />
                <input type="text" placeholder="Zipcode" />
              </div>
              <div className={styles.optional_input_wrapper}>
                <input type="text" placeholder="Optional" />
              </div>
            </div>
          </div>
          <div className={styles.delivery_channel_wrapper}>
            <label className={styles.custom_radio_checkbox}>
              <div className={styles.channel_input_wrapper}>
                <input type="radio" name="radio" defaultChecked />

                <div className={styles.channel_input_text_wrapper}>
                  <div>DHL</div>
            ...
            <label className={styles.custom_radio_checkbox}>
              <div className={styles.channel_input_wrapper}>
                <input type="radio" name="radio" defaultChecked />
                <div className={styles.channel_input_text_wrapper}>
                  <div>GIG LOGISTICS</div>
                  <div>3-5 Business days</div>
                </div>
              </div>
            </label>
          </div>
          <div className={styles.payment_button_wrapper}>
            <div>Continue to Payment</div>
          </div>
        </div>
      </div>
      <div className={styles.review_cart}>
        <div className={styles.review_cart_sub_container}>
          <div className={styles.review_cart_text}>Review cart</div>
          <div className={styles.review_cart_content}></div>
          <div className={styles.review_cart_total}>
            <div className={styles.cart_content_middle_content_sub_container}>
              <div className={styles.cart_content_middle_product_content}>
                <div
                  className={styles.cart_content_middle_product_content_image}
                >
                  <Image
                ...
                >
                  ...
                  <div className={styles.review_cart_product_quantity}>
                    Quanity: 1
                  </div>
