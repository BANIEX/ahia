    ...
    <div className={styles.cart_content}>
      ...
      <div className={styles.cart_content_middle}>
        ...
        <div className={styles.cart_content_middle_content}>
          ...
          {/* This div below represents one cart Product div */}
          ...
          {cart_products_array.map((cartProductObject) => (
              <CartProduct key={cartProductObject.id} cartProduct={cartProductObject} />
            
          ))}
        </div>
      </div>
      <div className={styles.cart_content_bottom}>
        <div>Subtotal: {"\u20A6"}175,000</div>
